...
function __sendEmail($to, $reseller, $domain, $phonenumber, $password, $name, $client_id, $client_secret)
  {
    // subject
    $subject = 'Access to OneCloud Beta Server';
    ...
    // Additional headers
    //$headers .= "To: $to" . "\r\n";
    $headers .= 'From: demo@OneCloud.com' . "\r\n";
...
<link rel="shortcut icon" type="image/x-icon"
	href="https://sandbox-core1.telware.net/SiPbx/getimage.php?filename=favicon.gif&server=oneclouduc.telware.net" />
<link rel="icon" type="image/x-icon"
	href="https://sandbox-core1.telware.net/SiPbx/getimage.php?filename=favicon.gif&server=oneclouduc.telware.net" />

<link rel="stylesheet"
	href="https://sandbox-core1.telware.net/portal/css/bootstrap.min.css"
	type="text/css">
<link rel="stylesheet"
	href="https://sandbox-core1.telware.net/portal/css/jquery-ui-1.10.bootstrap.css"
	type="text/css">
...
<body>
	...
	<div id="login-container">
		...
		<div id="login-group">
			...
			<div id="footer">
				<p>Example by TelWare Corporation</p>
